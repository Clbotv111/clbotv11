...
ᴜᴩᴛɪᴍᴇ: <code>{currentTime}</code>
ᴄᴩᴜ ᴜꜱᴀɢᴇ: <code>{cpu_usage}%</code>
Rᴀᴍ ᴜꜱᴀɢᴇ: <code>{ram_usage}%</code>
ᴛᴏᴛᴀʟ ᴅɪꜱᴋ ꜱᴩᴀᴄᴇ: <code>{total}</code>
ᴜꜱᴇᴅ ꜱᴩᴀᴄᴇ: <code>{used} ({disk_usage}%)</code>
ꜰʀᴇᴇ ꜱᴩᴀᴄᴇ: <code>{free}</code> """
